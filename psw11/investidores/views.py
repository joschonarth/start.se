...
def sugestao(request):
    ...
    if request.method == "GET":   
        ...
        #TODO: Tipo genérico de empresa, "mediano" por exemplo, investidor nem conservador nem despojado
...
def ver_empresa(request, id):
    ...
    return render(request, 'ver_empresa.html', {'empresa': empresa, 'documentos': documentos, 'percentual_vendido': int(percentual_vendido), 'percentual_disponivel': percentual_disponivel})
